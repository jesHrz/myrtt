...
SYSCALL_VOID_1(exit, _exit, __NR_exit, int)

SYSCALL_2(nanosleep, nanosleep, __NR_nanosleep, const struct timespec *, struct timespec *)
SYSCALL_2(settimeofday, settimeofday, __NR_settimeofday, struct timeval *, struct timeval *)
...
SYSCALL_1(close, _close, __NR_close, int)
...
SYSCALL_2(gettimeofday, gettimeofday, __NR_gettimeofday, struct timeval*, struct timeval*)
